...
if __name__=='__main__': 
    ...
    argparser.add_argument('-n', type=int, choices=[2, 4, 8], help='Num of multi job.')
    argparser.add_argument('-w', action='store_true', help='Save the scan result to current folder.')
    argparser.add_argument('-v', action='store_true', help='Show the time spending for scan test.')
